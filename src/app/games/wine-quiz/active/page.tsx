    ...
    <main className="relative min-h-screen flex flex-col pb-10 px-4 pt-4 bg-[url('/pic/fon.png')] bg-cover bg-center bg-no-repeat">
      ...
      <div className="w-full max-w-md mx-auto mt-14 flex flex-col gap-6">
        <div>
          ...
          <h1 className="mt-3 text-center wine-quiz-page-title text-4xl md:text-6xl font-bold">
            Мои активные игры
          </h1>
        </div>
            ...
            {list.map((game) => (
              <li key={game.id}>
                <button
                  ...
                  className="w-full text-left rounded-2xl border-4 border-[var(--wine-quiz-active-game-card-border)] bg-[var(--wine-quiz-active-game-card-bg)] p-4 shadow-md hover:bg-[var(--wine-quiz-active-game-card-bg-hover)] hover:border-[var(--wine-quiz-active-game-card-border-hover)] transition-colors focus:outline-none focus:ring-2 focus:ring-[var(--wine-quiz-active-game-card-focus-ring)] focus:ring-offset-2 focus:ring-offset-[var(--background)]"
                >
